...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    internal class ApplicationStorage : IApplicationStorage
    {
        ...
        bool IApplicationStorage.TryReadSetting(string name, out object value)
        {
            ...
            try
            {
                using (FileStream fileStream = new FileStream(string.Concat(this.StoragePrefix, name), FileMode.OpenOrCreate, FileAccess.Read))
                {
        ...
        void IApplicationStorage.WriteSetting(string name, object value)
        {
            ...
            try
            {
                using (FileStream fileStream = new FileStream(string.Concat(this.StoragePrefix, name), FileMode.OpenOrCreate, FileAccess.Write))
                {
